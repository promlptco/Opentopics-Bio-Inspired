...
OUT_BASE = os.path.join(PROJECT_ROOT, "outputs", "phase4_neutral_drift_baseline", "03_bounded_random_walk_proof")
...
if __name__ == "__main__":
    ...
    ceiling_snap_paths = sorted(glob.glob(
        os.path.join(PROJECT_ROOT, "outputs", "phase4_neutral_drift_baseline",
